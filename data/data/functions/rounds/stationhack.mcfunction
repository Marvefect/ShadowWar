...
execute as @e[type=interaction,tag=Station] at @s in data:map as @p[distance=..3,tag=Hacking,team=Red] run title @s subtitle {"text": "Starting Hack..."}
...
execute as @e[type=interaction,tag=StA] at @s in data:map if score @p[distance=..3,tag=Hacking,team=Red] Time matches 100 run title @a subtitle {"text": "Hack Started at Station A!","color": "red"}
execute as @e[type=interaction,tag=StB] at @s in data:map if score @p[distance=..3,tag=Hacking,team=Red] Time matches 100 run title @a subtitle {"text": "Hack Started at Station B!","color": "red"}
execute as @e[type=interaction,tag=Station] at @s in data:map as @p[distance=..3,tag=Hacking,team=Blue] run title @s subtitle {"text": "Stopping Hack..."}
