...
execute as @a[scores={EquipmentSlot1=3},tag=!EqS1used,advancements={data:trigger_fire=true}] if entity @s[nbt={SelectedItemSlot:2}] at @s anchored eyes run summon armor_stand ^ ^ ^1 {HandItems:[{id:"green_shulker_box",Count:1}],NoGravity:1b,Small:1b,NoBasePlate:1b,Tags:[HE,Grenade,Time],Invisible:1b}
execute as @a[scores={EquipmentSlot2=3},tag=!EqS2used,advancements={data:trigger_fire=true}] if entity @s[nbt={SelectedItemSlot:3}] at @s anchored eyes run summon armor_stand ^ ^ ^1 {HandItems:[{id:"green_shulker_box",Count:1}],NoGravity:1b,Small:1b,NoBasePlate:1b,Tags:[HE,Grenade,Time],Invisible:1b}
execute as @a[scores={EquipmentSlot1=4},tag=!EqS1used,advancements={data:trigger_fire=true}] if entity @s[nbt={SelectedItemSlot:2}] at @s anchored eyes run summon armor_stand ^ ^ ^1 {HandItems:[{id:"gray_shulker_box",Count:1}],NoGravity:1b,Small:1b,NoBasePlate:1b,Tags:[Smoke,Grenade,Time],Invisible:1b}
execute as @a[scores={EquipmentSlot2=4},tag=!EqS2used,advancements={data:trigger_fire=true}] if entity @s[nbt={SelectedItemSlot:3}] at @s anchored eyes run summon armor_stand ^ ^ ^1 {HandItems:[{id:"gray_shulker_box",Count:1}],NoGravity:1b,Small:1b,NoBasePlate:1b,Tags:[Smoke,Grenade,Time],Invisible:1b}
