# Stats
execute as @a[scores={PrimaryWeapon=1},tag=!P.Reloading,tag=!Dev] run item replace entity @s hotbar.0 with iron_hoe[minecraft:custom_data={PWeapon:1},minecraft:custom_model_data=11,minecraft:unbreakable={},minecraft:custom_name="F57"] 1
...
execute as @a[scores={PrimaryWeapon=2},tag=!P.Reloading,tag=!Dev] run item replace entity @s hotbar.0 with diamond_hoe[minecraft:custom_data={PWeapon:2},minecraft:custom_model_data=12,minecraft:unbreakable={},minecraft:custom_name="CH-A"] 1
...
execute as @a[scores={PrimaryWeapon=3},tag=!P.Reloading,tag=!Dev] run item replace entity @s hotbar.0 with iron_hoe[minecraft:custom_data={PWeapon:3},minecraft:custom_model_data=13,minecraft:unbreakable={},minecraft:custom_name="CBR-C"] 1
...
execute as @a[scores={PrimaryWeapon=4},tag=!P.Reloading,tag=!Dev] run item replace entity @s hotbar.0 with diamond_hoe[minecraft:custom_data={PWeapon:4},minecraft:custom_model_data=14,minecraft:unbreakable={},minecraft:custom_name="Sawblade"] 1
...
execute as @a[scores={SecondaryWeapon=1},tag=!S.Reloading,tag=!Dev] run item replace entity @s hotbar.1 with stone_hoe[minecraft:custom_data={SWeapon:1},minecraft:custom_model_data=21,minecraft:unbreakable={},minecraft:custom_name="UP9"] 1
...
execute as @a[scores={SecondaryWeapon=2},tag=!S.Reloading,tag=!Dev] run item replace entity @s hotbar.1 with stone_hoe[minecraft:custom_data={SWeapon:2},minecraft:custom_model_data=22,minecraft:unbreakable={},minecraft:custom_name="K45"] 1
...
execute as @a[scores={SecondaryWeapon=3},tag=!S.Reloading,tag=!Dev] run item replace entity @s hotbar.1 with iron_hoe[minecraft:custom_data={SWeapon:3},minecraft:custom_model_data=23,minecraft:unbreakable={},minecraft:custom_name="S97"] 1
...
execute as @a[scores={SecondaryWeapon=4},tag=!S.Reloading,tag=!Dev] run item replace entity @s hotbar.1 with golden_hoe[minecraft:custom_data={SWeapon:4},minecraft:custom_model_data=24,minecraft:unbreakable={},minecraft:custom_name="Raven"] 1
...
execute as @a[tag=!Spectating,tag=!Dev] run item replace entity @s weapon.offhand with ender_eye 
