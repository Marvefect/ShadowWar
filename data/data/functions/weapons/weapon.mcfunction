...
execute as @a[scores={PrimaryWeapon=1},tag=!P.Reloading] run item replace entity @s hotbar.0 with iron_hoe{Interaction:1,CustomModelData:11,Unbreakable:1b,PWeapon:1,display:{Name:'{"text":"F57","bold":true}',Lore:['[{"text":"Damage: 5","italic":false}]','[{"text":"Firerate: 0.15s","italic":false}]','[{"text":"Capacity: 30","italic":false}]','[{"text":"Reload Time: 3s","italic":false}]','[{"text":"Recoil: 0.1m","italic":false}]','[{"text":"Spread: 15°","italic":false}]']},HideFlags:6} 1
...
execute as @a[scores={PrimaryWeapon=2},tag=!P.Reloading] run item replace entity @s hotbar.0 with netherite_hoe{Interaction:1,CustomModelData:12,Unbreakable:1b,PWeapon:2,display:{Name:'{"text":"CH-A","bold":true}',Lore:['[{"text":"Damage: 70","italic":false}]','[{"text":"Firerate: 3s","italic":false}]','[{"text":"Capacity: 5","italic":false}]','[{"text":"Reload Time: 4s","italic":false}]','[{"text":"Recoil: 1m","italic":false}]','[{"text":"Spread: 5°","italic":false}]']},HideFlags:6} 1
...
execute as @a[scores={PrimaryWeapon=3},tag=!P.Reloading] run item replace entity @s hotbar.0 with iron_hoe{Interaction:1,CustomModelData:13,Unbreakable:1b,PWeapon:3,display:{Name:'{"text":"CBR-C","bold":true}',Lore:['[{"text":"Damage: 12","italic":false}]','[{"text":"Firerate: 0.35s","italic":false}]','[{"text":"Capacity: 20","italic":false}]','[{"text":"Reload Time: 3s","italic":false}]','[{"text":"Recoil: 0.2m","italic":false}]','[{"text":"Spread: 10°","italic":false}]']},HideFlags:6} 1
...
execute as @a[scores={PrimaryWeapon=4},tag=!P.Reloading] run item replace entity @s hotbar.0 with netherite_hoe{Interaction:1,CustomModelData:14,Unbreakable:1b,PWeapon:4,display:{Name:'{"text":"Sawblade","bold":true}',Lore:['[{"text":"Damage: 5","italic":false}]','[{"text":"Firerate: 0.1s","italic":false}]','[{"text":"Capacity: 100","italic":false}]','[{"text":"Reload Time: 6s","italic":false}]','[{"text":"Recoil: 0.07m","italic":false}]','[{"text":"Spread: 20°","italic":false}]']},HideFlags:6} 1
...
execute as @a[scores={SecondaryWeapon=1},tag=!S.Reloading] run item replace entity @s hotbar.1 with iron_hoe{Interaction:1,CustomModelData:21,Unbreakable:1b,SWeapon:1,display:{Name:'{"text":"UP-9","bold":true}',Lore:['[{"text":"Damage: 12","italic":false}]','[{"text":"Firerate: 0.5s","italic":false}]','[{"text":"Capacity: 12","italic":false}]','[{"text":"Reload Time: 2.5s","italic":false}]','[{"text":"Recoil: 0.3m","italic":false}]','[{"text":"Spread: 10°","italic":false}]']},HideFlags:6} 1
...
execute as @a[scores={SecondaryWeapon=3},tag=!S.Reloading] run item replace entity @s hotbar.1 with golden_hoe{Interaction:1,CustomModelData:23,Unbreakable:1b,SWeapon:3,display:{Name:'{"text":"Raven","bold":true}',Lore:['[{"text":"Damage: 30","italic":false}]','[{"text":"Firerate: 1s","italic":false}]','[{"text":"Capacity: 8","italic":false}]','[{"text":"Reload Time: 3s","italic":false}]','[{"text":"Recoil: 0.8m","italic":false}]','[{"text":"Spread: 25°","italic":false}]']},HideFlags:6} 1
