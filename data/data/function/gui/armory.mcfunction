...
execute as @e[type=interaction,tag=Secondary3] at @s if data entity @s interaction as @p[distance=..2,scores={Level=10..}] run scoreboard players set @s SecondaryWeapon 3
execute as @e[type=interaction,tag=Secondary4] at @s if data entity @s interaction as @p[distance=..2,scores={Level=15..}] run scoreboard players set @s SecondaryWeapon 4
